...
INSERT INTO eip_group(g_id, type_id, m_site, g_name, g_creator, g_create_date, g_create_time, g_desc, g_level, g_parentid, g_code, g_is_ad)
...
GO
INSERT INTO eip_group_member(m_site, m_account, g_id, join_date, join_time, join_note, status)
...
GO
INSERT INTO eip_member(m_uid, m_site, m_account, m_password, m_lockpass, m_block, m_hint, m_hint_ans, m_nickname, m_name, m_email, m_birthday, m_gender, m_create_date, m_create_time, m_enctype, m_last_date, m_last_time, m_log_count, change_pwd_date, change_pwd_duration, m_last_modify_date, m_type, photo_name, is_ad)
